...
#
# modify : insert operations for "iaddq"
# I wrote "# modified by MYT" where I modified
#fetch stage: instr_valid, need_regids, need_valC (In order to understand if it is valid register)
#decode stage: d_srcB=D_rB, d_dstE=D_rB (In order to connect destination and source)
#execute stage: aluA=E_valA, aluB=E_valB, set_CC (In order to execute register)
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IIADDQ };             # modified by MYT
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ };		# modified by MYT

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IIADDQ };		# modified by MYT
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IIADDQ } : D_rB;		# modified by MYT
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ } : D_rB;		# modified by MYT
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ } : E_valC;		# modified by MYT
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IIADDQ } : E_valB;		# modified by MYT
...
bool set_cc = E_icode in { IOPQ, IIADDQ } &&					# modified by MYT
